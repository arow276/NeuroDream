...
import { Brain, Mail, Lock, User, ArrowLeft, Github, Chrome } from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-neuro-400/20 to-neuro-600/20 border border-neuro-500/30 flex items-center justify-center mx-auto mb-5">
            <Mail size={28} className="text-neuro-400" />
          </div>
          <h1 className="text-2xl font-display font-bold text-[var(--text-primary)] mb-2">Check Your Email</h1>
          ...
          <Link href="/auth/login" className="btn btn-secondary inline-flex">
            Back to Login
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-display font-bold text-[var(--text-primary)] mb-1">Create Your Journal</h1>
          <p className="text-sm text-[var(--text-secondary)]">Start your dream wellness journey</p>
        </div>
        ...
        <div className="card p-5 sm:p-6 space-y-5">
          ...
          <p className="text-center text-sm text-[var(--text-secondary)]">
            ...
            <Link href="/auth/login" className="text-dream-400 hover:text-dream-300 transition-colors font-medium">
              Sign in
            </Link>
          </p>
        </div>
